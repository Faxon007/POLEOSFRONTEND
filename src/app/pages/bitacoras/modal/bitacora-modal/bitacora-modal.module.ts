...
import { BitacoraModalComponent } from './bitacora-modal.component'
...
@NgModule({
	declarations: [BitacoraModalComponent],
	imports: [
		CommonModule,
		IonicModule,
		FormsModule,
	...
	exports: [BitacoraModalComponent],
})
export class BitacoraModalModule {}
